...
public class IOHelper {
    ...
    /**
     * Deletes file or directory, even if it is non-empty. Returns false only if the object is not
     * found or can not be deleted due to lacking permissions.
     * 
     * @param path
     * @return
     */
    ...
    public static void processFromFile(String path,
                                       String encoding,
    ...
    public static void processFromStream(InputStream stream,
                                         String encoding,
                                         Consumer<String> lineProcessor,
                                         Consumer<String> headerProcessor)
            throws IOException {
    ...
    public static void processFromZip(String zipPath,
                                      String encoding,
                                      Function<String, ZipAction> decider,
                                      Consumer<String> lineProcessor,
                                      Consumer<String> headerProcessor)
            throws IOException {
    ...
    public static void processFromZip(String zipPath,
                                      String encoding,
                                      Predicate<String> useDecider,
                                      boolean returnOnSkip,
                                      Consumer<String> lineProcessor,
                                      Consumer<String> headerProcessor)
            throws IOException {
    ...
    public static void addFilesToZip(Iterable<String> sourceFiles,
                                     Function<String, String> pathInZip,
                                     String encoding,
                                     String targetZip)
            throws IOException {
