...
public class Enumeration {
    ...
    public Element getElement(String name) {
        ...
        throw new IllegalArgumentException("Enumeration '" + getName()
                                           + "' does not contain element '" + name + "'");
    }
    ...
    public static class Element {
        ...
        public <T> Element(String name, T value, String parent) {
            ...
            if (value == null) {
                throw new IllegalArgumentException("Cannot create an element '" + name
                                                   + "' with null-value");
            }
            if (parent == null) {
                throw new IllegalArgumentException("Cannot create an element '" + name
                                                   + "' without the enumeration reference");
            }
            this.name = name;
            this.value = value;
            this.parent = parent;
