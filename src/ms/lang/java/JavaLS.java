...
public class JavaLS extends AbstractLS {
    ...
    protected List<TypeLoader> initTypeLoaders() {
        return Arrays.asList(new TypeLoader(this::loadPrimitive, TypeLoader::noPackage), //
                             new TypeLoader(this::loadStdClass,
                                            p -> TypeLoader.add(p, asList("java.lang.*"))));
    }
    ...
    public Object eval(String source, TypeName type) {
        ...
        if (parser != null) {
            ...
            logger.debug("Evaluating value {} with type {}: result={} of class {}",
                         source,
                         type,
                         result,
     ...
     */
    @Override
    public void forEachUserType(String packageName,
                                Predicate<IType> pred,
