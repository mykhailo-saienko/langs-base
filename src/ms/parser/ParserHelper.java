...
public class ParserHelper {
    ...
    public static <T extends Throwable> T createError(Class<T> wrapper,
                                                      String message,
                                                      List<Error> errors) {
        if (wrapper == null) {
        ...
        try {
            ...
            logger.fatal("Unexpected error while instantiating a constructor for "
                         + wrapper.getName() + ". This is a design-issue",
                         e1);
        }
    ...
    public static <T extends Throwable> void checkErrors(Parser parser,
                                                         String message,
                                                         Class<T> errorClass)
            throws T {
